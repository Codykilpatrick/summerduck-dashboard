...
const StatisticsComponent = () => {
  ...
  const processStatistics = (data: RaceRecord[]) => {
    ...
    // Most Wins
    const winsByDriver = data.reduce(
      (acc, race) => {
        if (race.WinLoss === 'Win') {
          if (!acc[race.Driver]) {
            acc[race.Driver] = {
    ...
    const driverProgress = data.reduce(
      (acc, race) => {
      ...
      {} as Record<
        string,
        { driver: string; carNo: string; runs: Array<{ date: string; et: number }> }
      >
    );
    ...
    const improvementData = Object.values(driverProgress)
      ...
      .map(driver => {
        // Sort runs by date
        const sortedRuns = [...driver.runs].sort(
    ...
    const driverMphProgress = data.reduce(
      (acc, race) => {
      ...
      {} as Record<
        string,
        { driver: string; carNo: string; runs: Array<{ date: string; mph: number }> }
      >
    );
    ...
    <div className="p-6 bg-gray-900 text-gray-200 min-h-screen">
      ...
      <div className="mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Top Speed */}
          <div className="bg-gray-800 rounded-lg border border-gray-700 p-4 shadow-lg">
            <h3 className="text-xl font-semibold mb-3 text-center text-green-400">
              Top 1/8 Mile Speed
            </h3>
            <div className="overflow-x-auto">
              <table className="w-full table-auto">
                ...
                <tbody>
                  {topSpeed.map((entry, index) => (
                    <tr key={index} className="border-b border-gray-700 hover:bg-gray-700">
                      ...
                      <td className="px-2 py-2 font-semibold text-green-400">
                ...
                <tbody>
                  {bestReaction.map((entry, index) => (
                    <tr key={index} className="border-b border-gray-700 hover:bg-gray-700">
                      ...
                      <td className="px-2 py-2 font-semibold text-yellow-400">
                        {formatTime(entry.value)}
                      </td>
                      <td className="px-2 py-2">{entry.date}</td>
                    </tr>
                ...
                <tbody>
                  {best60ft.map((entry, index) => (
                    <tr key={index} className="border-b border-gray-700 hover:bg-gray-700">
                      ...
                      <td className="px-2 py-2 font-semibold text-pink-400">
                        {formatTime(entry.value)}
                      </td>
                      <td className="px-2 py-2">{entry.date}</td>
                    </tr>
          ...
          {/* Best Win Rate */}
          <div className="bg-gray-800 rounded-lg border border-gray-700 p-4 shadow-lg">
            <h3 className="text-xl font-semibold mb-3 text-center text-orange-400">
              Best Win Rate (Min 3 Races)
            </h3>
            <div className="overflow-x-auto">
              <table className="w-full table-auto">
                <thead>
      ...
      <div className="mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          {/* Consistency Ranking */}
          <div className="bg-gray-800 rounded-lg border border-gray-700 p-4 shadow-lg">
            <h3 className="text-xl font-semibold mb-3 text-center text-gray-200">
              Most Consistent Drivers (1/8 ET)
            </h3>
              ...
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <XAxis
                    ...
                    label={{
                      value: 'ET Improvement Percentage',
                      position: 'bottom',
                      fill: '#E4E4E7',
                    }}
              ...
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <XAxis
                    ...
                    domain={['dataMin - 0.1', 'dataMax + 0.1']}
                    label={{
                      value: 'MPH Improvement Percentage',
                      position: 'bottom',
                      fill: '#E4E4E7',
                    }}
